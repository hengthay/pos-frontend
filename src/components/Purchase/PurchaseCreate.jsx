...
import { createPurchase, resetPurchaseStatus } from '../../feature/purchases/purchaseSlice';
...
const PurchaseCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        title: "Created",
        text: "Your Purchase is created successfully!",
        icon: "success",
        timer: 1500,
      });
      ...
      Swal.fire({
        title: "Failed",
        text: "Your Purchase is created failed!",
        icon: "error",
        timer: 1500,
      });
      console.log(error);
      ...
      <div className="flex md:items-center items-start justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Fill in the form to create a new purchase.
          </p>
        </div>
