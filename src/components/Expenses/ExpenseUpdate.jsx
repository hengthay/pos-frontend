...
import { fetchExpenseById, resetExpenseStatus, selectExpenseDetailData, selectExpenseStatusDetail, updateExpense } from '../../feature/expenses/expenseSlice';
...
const ExpenseUpdate = () => {
  ...
  const expenseStatus = useSelector(selectExpenseStatusDetail);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        title: "Updated",
        text: "Your Expense is updated successfully!",
        icon: "success",
        timer: 1500,
      });
      ...
      Swal.fire({
        title: "Failed",
        text: "Your Expense is updated failed!",
        icon: "error",
        timer: 1500,
      });
      console.log(error);
      ...
      <div className="flex md:items-center items-start justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Fill in the form to update a Expense.
          </p>
        </div>
