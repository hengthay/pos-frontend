...
import { createProduct, resetProductStatus } from '../../feature/products/productSlice'
...
const ProductCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        title: "Created",
        text: "Your Product is created successfully!",
        icon: "success",
        timer: 1500,
      });
      ...
      Swal.fire({
        title: "Failed",
        text: "Your Product is created failed!",
        icon: "error",
        timer: 1500,
      });
      console.log(error);
