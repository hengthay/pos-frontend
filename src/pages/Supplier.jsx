...
import { fetchSuppliers, selectSupplierError, selectSuppliersData, selectSupplierStatus } from '../feature/suppliers/supplierSlice'
...
const Supplier = () => {
  ...
  useEffect(() => {
    if(page) dispatch(fetchSuppliers({ page: page }));
  }, [page, dispatch]);
